...
# Preprocessor: Apply StandardScaler to numeric features and passthrough the rest (one-hot encoded categorical features)
preprocessor = make_column_transformer(
    (StandardScaler(), numeric_features),
    remainder='passthrough'  # This will keep the one-hot encoded columns as they are
)
