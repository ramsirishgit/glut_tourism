...
if st.button("Predict Purchase"):
    ...
    st.subheader(f"Prediction Result for the buyer:")
    st.success(f"With a probability of {prediction}, this buyer is predicted to {'NOT' if prediction < 0.5 else ''} purchase the plan.")
